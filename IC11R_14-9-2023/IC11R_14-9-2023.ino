...
IPAddress local_IP(192, 168, 68, 90); // Static IP 
IPAddress gateway(192, 168, 68, 1);    // Gateway IP address
IPAddress subnet(255, 255, 255, 0);     // subnet

char Machine_no[] = "IC11R";
...
String alarmNames[maxAlarms] = {
  "SIDE DRESS FOR ERROR",
  "SIDE DRESS REV ERROR",
  "WORN WHEEL",
  "LOADING ERROR",
  "DOOR OPEN",
  "FULL WORK",
  "CHUTE EMPTY",
  "TRANFER LOADER ERROR",
  "AFTER DRESS STOP",
  "SPINOUT",
  "G.WHEEL MOTOR OVER LOAD",
  "SPARKOUT HOLD MODE",
  "RADIAL DRESS ERROR",
  "NEXT M/C CHUTE FULL",
  "LINE UP PUSHER ERROR",
  "DOOR OPEN STOP",
  "TRANFER LOADER NO WORK",
  "WORN WHEEL NOTICE",
  "SERVO AMP BATTERY ALARM",
  "GE-ON",
  "GE NOT READY",
  "R/W BIG",
  "G.W TABLE ORIGIN REQUEST",
  "PICK UP ORIGIN REQUEST",
  "LINE UP ORIGIN REQUEST",
  "GE NOT ON",
  "MAGENT CHUCK ON/OFF",
  "ROTARY DRESSER RUN ERROR",
  "GE CHECK MODE",
  "GE NOISE CHECK",
};
...
void sent_ftp_alarm()
{
  ...
  if (Count3 > 2)
  {
    ...
    if (dataFile1) {
      ...
      if (content1.length() > 0) {
        ...
        ftp.NewFile("nht_gd_alarmlist_ic11r.txt");
  ...
  {
    Serial.println("Failed to open nht_gd_alarmlist_ic11r.txt Empty");
    delay(1000);
  }
...
void sent_ftp_mc()
{
  ...
  if (Count4 > 2)
  {
    ...
    if (dataFile2) {
      ...
      if (content2.length() > 0) {
        ...
        ftp.NewFile("nht_gd_mcstatus_ic11r.txt");
  ...
  {
    Serial.println("Failed to open nht_gd_mcstatus_ic11r.txt Empty");
    delay(1000);
  }
}
