...
IPAddress local_IP(192, 168, 68, 92); // Static IP
IPAddress gateway(192, 168, 68, 1);    // Gateway IP address
IPAddress subnet(255, 255, 255, 0);     // subnet

char Machine_no[] = "IC11H";
...
String alarmNames[maxAlarms] = {
  "H-1 LOADING ERROR",
  "H-1 ARM FWD ERROR",
  "H-1 TOOL ENGAGE IN ERROR",
  "H-1 TOOL ENGAGE OUT ERROR",
  "H-1 ARM REV ERROR",
  "TR-1 LOADER ERROR",
  "TR-1 STEP CHECK ERROR",
  "TR-1 PUSHER ERROR",
  "H-1 ARM CENTER ERROR",
  "TR-1 NO PART",
  "H-1 FLOATLESS SW ERROR",
  "H-2 LOADING ERROR",
  "H-2 ARM FWD ERROR",
  "H-2 TOOL ENGAGE IN ERROR",
  "H-2 TOOL ENGAGE OUT ERROR",
  "H-2 ARM REV ERROR",
  "TR-2 LOADER ERROR",
  "TR-2 STEP CHECK ERROR",
  "TR-2 PUSHER ERROR",
  "H-2 ARM CENTER ERROR",
  "H-2 FLOATLESS SW ERROR",
  "NO USE",
  "NO USE",
  "NO USE",
  "NO USE",
...
void sent_ftp_alarm()
{
  ...
  if (Count3 > 2)
  {
    ...
    if (dataFile1) {
      ...
      if (content1.length() > 0) {
        ...
        ftp.NewFile("nht_gd_alarmlist_ic11h.txt");
  ...
  {
    Serial.println("Failed to open nht_gd_alarmlist_ic11h.txt Empty");
    delay(1000);
  }
...
void sent_ftp_mc()
{
  ...
  if (Count4 > 2)
  {
    ...
    if (dataFile2) {
      ...
      if (content2.length() > 0) {
        ...
        ftp.NewFile("nht_gd_mcstatus_ic11h.txt");
  ...
  {
    Serial.println("Failed to open nht_gd_mcstatus_ic11h.txt Empty");
    delay(1000);
  }
}
